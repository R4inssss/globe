...
class MainText:
    ...
    def AirDialogue(self):
        ...
        return self.A1text, self.A2text
    ...
    def WaterDialogue(self):
        ...
        return self.B1text, self.B2text
    ...
    def CarbonDialogue(self):
        ...
        return self.C1text, self.C2text


    def SurfaceDialogue(self):
        self.E1text = [{'A': ''}, {'B': ''}, {'C': ''}, {'D': ''}]
        self.E2text = [{'A': ''}, {'B': ''}, {'C': ''}, {'D': ''}]
        return self.E1text, self.E2text


    def CorrectAnswers(WaterDialogue):
        pass
